...
class PruneHandler():
    ...
    def reconsruction_bottle_DBC(self):
    ...
    def reconstruction_model(self, block, DBC):
        ...
        if DBC == False:
            ...
            self.get_remain_index_DBC()
            self.reconsruction_bottle_DBC()
        return self.model